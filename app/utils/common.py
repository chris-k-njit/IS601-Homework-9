...
def encode_url_to_filename(url):
    ...
    """
    sanitized_url = validate_and_sanitize_url(str(url)) # spelling mistake here, wasn't matching if statement below
...
def decode_filename_to_url(encoded_str: str) -> str:
    ...
    decoded_bytes = base64.urlsafe_b64decode(encoded_str) # matching decode and encode, adjusted urlsafe after underscore here
